...
export default function Page({ dark, handleDark }) {
  return (
    <main className="w-[100dvw] min-h-[100dvh] bg-[#f1faff] dark:bg-[#15202B] relative overflow-hidden pb-5">
      ...
      <header className="w-[100dvw] h-[100px] z-2 p-4 flex justify-between">
        <div></div>
        <button
          className="size-10 bg-white/60 hover:bg-white dark:bg- transition-colors text-blue-900 relative  grid justify-center items-center rounded-md"
          onClick={handleDark}
        >
